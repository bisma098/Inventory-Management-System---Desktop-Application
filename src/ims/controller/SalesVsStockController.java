...
public class SalesVsStockController {
    ...
    private void loadReportData() {
        String sql = 
            ...
            "    ISNULL(SUM(b.availableQty), 0) AS totalStock, " +
            "    ISNULL(SUM(sol.quantity), 0) AS totalSold, " +
            "    (ISNULL(SUM(b.availableQty), 0) - ISNULL(SUM(sol.quantity), 0)) AS stockRemaining " +
            "FROM products p " +
    ...
    private void downloadCSV() {
        try {
            String desktopPath = System.getProperty("user.home") + "/Desktop/SalesVsStockReport.csv";
